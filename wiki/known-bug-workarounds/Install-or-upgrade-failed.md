...
Workaround:
- Open the Syncthing Refined menu -> Import & Export -> Export config
- Open the Syncthing Refined menu -> Exit
- Android settings -> Apps -> Syncthing Refined -> Force stop
- Android settings -> Apps -> Syncthing Refined -> Uninstall, do NOT keep data when Android asks (this refers to the app's config, not your synced folders)
- Install latest release
- Open the Syncthing Refined menu -> Import & Export -> Import config
