nVidia Shield TV's Android OS seem to lack the "regular" battery optimization consent and settings dialogs as they are known from mobile phones and tablets. Because of the missing functionality, you can't setup Syncthing Refined on those TV's without making some steps to prepare the installation of the Syncthing Refined app first.
...
```
    adb devices
```
* To whitelist Syncthing Refined from doze / Android Battery Optimization, type the following
```
