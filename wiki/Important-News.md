...
Syncthing Refined v1.30.0.4 was the last release for v1. Your action is required to update to v2.0.7.0+ when you feel ready to do it.
...
Upgrading Syncthing Refined from v2.0.3.0 or v1.30.x to v2 involves the following steps:
...
Open your currently installed version of Syncthing Refined.
...
Uninstall the Syncthing Refined app.
