...
You can receive the folder sync complete event from Syncthing Refined by using a BroadcastReceiver to subscribe.
...
- Start test app and follow the logcat while Syncthing Refined is running and about to complete a folder sync progress.
```
